    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        if provided_dns_provider:
            ...
            if existing_provider and existing_provider != settings.get(
                ...
                if confidence >= 70:
                    ...
                    print(
                        f"   Using smart suggestion: {dns_provider} (confidence: {confidence}%)"
                    )
                else:
        ...
        if account_config:
            ...
            if provider_match and account_match:
                print(
                    f"   ✓ Result matches expectations: {dns_provider}/{used_account_id}"
                )
            else:
            ...
            print(
                f"   ✗ No account configuration found for {dns_provider}/{account_id}"
            )
