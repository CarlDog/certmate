...
def create_client_certificate_models(api):
    ...
    client_cert_model = api.model(
        "ClientCertificate",
        {
            "identifier": fields.String(
                required=True, description="Certificate identifier"
            ),
    ...
    client_cert_request_model = api.model(
    ...
    client_cert_revoke_model = api.model(
        ...
        def get(self):
            ...
            try:
                ...
                certs = client_cert_manager.list_client_certificates(
                    cert_usage=cert_usage, revoked=revoked, search_term=search
                )
    ...
    class ClientCertificateCreate(Resource):
        def post(self):
            ...
            try:
                ...
                # Create certificate
                success, error, cert_data = (
                    client_cert_manager.create_client_certificate(
    ...
    class ClientCertificateBatch(Resource):
        def post(self):
            ...
            try:
                ...
                logger.info(
                    f"Batch certificate creation: {results['successful']}/{results['total']} successful"
                )
                return results, 201
