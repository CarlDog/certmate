...
def test_domain_alias_in_certbot_command():
    ...
    strategy.configure_certbot_arguments(
        cmd, credentials_file, domain_alias=domain_alias
    )
...
def test_certificate_manager_with_domain_alias():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        settings_manager.save_settings(
            {
                ...
                "dns_providers": {
                    "cloudflare": {
                        "accounts": {
                            "default": {"api_token": "test_token_1234567890abcdef"}
                        }
                    }
                },
            }
        ...
        mock_executor.set_next_result(
            returncode=0, stdout="Certificate created successfully"
        )
